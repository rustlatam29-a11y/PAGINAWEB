        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-xl rounded-2xl p-6 border border-red-900/30 text-center hover:scale-105 transition-transform duration-300">
                <Gift className="w-12 h-12 text-red-500 mx-auto mb-4" />
                <h3 className="text-white font-bold text-lg mb-2">Beneficios Exclusivos</h3>
                <p className="text-gray-400 text-sm">Acceso a contenido y features premium del servidor</p>
              </div>
              
              <div className="bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-xl rounded-2xl p-6 border border-red-900/30 text-center hover:scale-105 transition-transform duration-300">
                <Sparkles className="w-12 h-12 text-red-500 mx-auto mb-4" />
                <h3 className="text-white font-bold text-lg mb-2">Skins VIP</h3>
                <p className="text-gray-400 text-sm">Colección exclusiva de skins para destacarte</p>
              </div>
              
              <div className="bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-xl rounded-2xl p-6 border border-red-900/30 text-center hover:scale-105 transition-transform duration-300">
                <Star className="w-12 h-12 text-red-500 mx-auto mb-4" />
                <h3 className="text-white font-bold text-lg mb-2">Prioridad Total</h3>
                <p className="text-gray-400 text-sm">Soporte prioritario y acceso preferencial</p>
              </div>
            </div>
          </div>
          ...
          {/* Garantía y Soporte */}
          <div className="max-w-4xl mx-auto mt-16 p-8 bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-xl rounded-3xl border border-red-900/30">
            <div className="text-center mb-8">
              <Shield className="w-16 h-16 text-red-500 mx-auto mb-4" />
              <h3 className="text-3xl font-bold text-white mb-3">Compra Segura y Garantizada</h3>
              <p className="text-gray-300 text-lg">Tu inversión está protegida con nuestro servicio premium</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4">
                <Rocket className="w-10 h-10 text-red-400 mx-auto mb-3" />
                <h4 className="text-white font-semibold mb-2">Activación Instantánea</h4>
                <p className="text-gray-400 text-sm">Tu VIP se activa inmediatamente después del pago</p>
              </div>
              
              <div className="text-center p-4">
                <Award className="w-10 h-10 text-red-400 mx-auto mb-3" />
                <h4 className="text-white font-semibold mb-2">Soporte 24/7</h4>
                <p className="text-gray-400 text-sm">Asistencia completa en Discord y Discord</p>
              </div>
            ...
            <div className="text-center">
              ...
              >
                ...
                <span>¿Dudas? Contáctanos por Discord</span>
