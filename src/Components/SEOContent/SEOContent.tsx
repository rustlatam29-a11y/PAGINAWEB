    ...
    <section className="relative py-12 lg:py-16 bg-gradient-to-b from-black via-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
          ...
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-red-900/30 card-hover">
            <Users className="w-12 h-12 text-red-500 mb-4 icon-bounce" />
            <h3 className="text-xl font-bold text-white mb-2">Comunidad Latina</h3>
            <p className="text-gray-400">La comunidad más grande de Rust en Latinoamérica con +10K jugadores</p>
          </div>
          
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-red-900/30 card-hover">
            <Server className="w-12 h-12 text-red-500 mb-4 icon-bounce" />
            <h3 className="text-xl font-bold text-white mb-2">Servidor Premium</h3>
            <p className="text-gray-400">Alta disponibilidad, bajo ping y experiencia optimizada 24/7</p>
          </div>
          
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-red-900/30 card-hover">
            <Shield className="w-12 h-12 text-red-500 mb-4 icon-bounce" />
            <h3 className="text-xl font-bold text-white mb-2">Anti-Cheat Activo</h3>
        ...
        <div className="max-w-4xl mx-auto mt-8">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50">
              <h3 className="text-xl font-bold text-red-400 mb-3">¿Cómo descargo Rust gratis?</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50">
              <h3 className="text-xl font-bold text-red-400 mb-3">¿LATAMRUST es un servidor latino?</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50">
              <h3 className="text-xl font-bold text-red-400 mb-3">¿Qué hace especial a LATAMRUST?</h3>
              <p className="text-gray-300">
